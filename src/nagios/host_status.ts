...
// #define CHECK_TYPE_FILE     3 /* from spool files (yuck) */
// #define CHECK_TYPE_OTHER    4 /* for modules to use */
function check_type_number_to_enum(
  check_type: string
...
// #define SOFT_STATE			0
// #define HARD_STATE			1
function state_type_to_enum(state_type: string): 'soft_state' | 'hard_state' {
  if (state_type == '0') {
    return 'soft_state';
  } else {
    return 'hard_state';
...
// #define ACKNOWLEDGEMENT_NORMAL          1
// #define ACKNOWLEDGEMENT_STICKY          2
function acknowledgement_type_to_enum(
